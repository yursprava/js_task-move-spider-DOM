...
document.addEventListener("click", (e)=>{
    ...
    if (field.contains(e.target)) {
        ...
        if (newSpiderLeft < minSpiderLeft) newSpiderLeft = minSpiderLeft;
        else if (newSpiderLeft > maxSpiderLeft) newSpiderLeft = maxSpiderLeft;
        if (newSpiderTop < minSpiderTop) newSpiderTop = minSpiderTop;
        else if (newSpiderTop > maxSpiderTop) newSpiderTop = maxSpiderTop;
